...
import { AnimationMixer, Group, SRGBColorSpace, TextureLoader, Vector2 } from 'three';
...
export class Pikachu extends Group {
    _mixer = new AnimationMixer(this);
    _idleAction;
    _runAction;
    constructor(username) {
        ...
        const gltf = Asset.get(GLTF_PICACHU_URL);
        ...
        const object = this.getObjectByName('PikachuF_6');
        const material = object.material.clone();
        object.material = material;
        material.map = texture;
        console.log(this.getObjectByName('PikachuF_6'));
        const map = this.getObjectByName('PikachuF_4').material.map;
